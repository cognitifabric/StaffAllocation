...
//// MUTATIONS
import ACTIVATE_ENTITY_ACCOUNT from '../../../../../mutations/activateEntityAccount'
...
const ActivateUserAccount = ({
  ...
  const [ activateAccount, { dataActivateForm, loadingActivateForm, errorActivateForm }] = useMutation(ACTIVATE_ENTITY_ACCOUNT)
  ...
  const activateAccountForm = async () => {
    ...
    try {
      ...
      setLoading('')
      setMessage(response.data.activateEntityAccount.message)
      router.push('/');
