...
const DeleteEntityUser = ({
  ...
  const [ deleteEntityUserMutation, { dataDeleteEntityUser, loadingDeleteEntityUser, errorDeleteEntityUser}] = useMutation(DELETE_ENTITY_USER, { refetchQueries: [ GET_USERS ]})
